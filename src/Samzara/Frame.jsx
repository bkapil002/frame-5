...
import { Mic, MicOff } from "lucide-react"; // Needed for mic icons
        ...
        {!isConnected ? (
          <div className="p-10 max-w-md mx-auto flex flex-col gap-4">
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600  cursor-pointer py-2 px-3 rounded"
            >
              Ready to join
            </button>
          </div>
          ...
          <>
            ...
            <div className="flex flex-col lg:flex-row flex-1 p-4 gap-4">
             ...
             {!isAdmin && (
              ...
              <div className="lg:w-1/5 w-full bg-white shadow rounded-lg p-2">
                ...
                <div className="grid grid-cols-4 lg:grid-cols-2 gap-2 mt-2">
                  ...
                  {requestingRemoteUsers.map(u => (
                    u.uid !== email &&
                    <div key={u.uid} className="w-20 h-20 mx-auto rounded-full object-cover flex items-center justify-center">
